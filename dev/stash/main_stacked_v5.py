...
class AppWindow(QMainWindow):
    def __init__(self):
        ...
        tool_buttons = {
            "DX Review": lambda: batch_create_reports(),  
            "Bidder RFIs": '',
            "Change Tracker": ''
        }
        ...
        tool_scene = Scene(scene_id='tools', scene_name='Tools', button_dict=tool_buttons)
        resc_scene = Scene(scene_id='resources', scene_name='Resources', button_dict=resc_buttons)
        help_scene = Scene(scene_id='help', scene_name='Help')
        scenes = [tool_scene, 
                  resc_scene, 
                  help_scene]
